                ...
                <div className="col-md-8 m-auto">
                    ...
                    <form onSubmit={this.onSubmit}>
                        <div className="form-group">
                            ...
                            className={classnames("form-control form-control-lg", {"is-invalid":errors.projectName})} placeholder="Project Name" />
                            {errors.projectName && (
                        ...
                        <div className="form-group">
                            ...
                            className={classnames("form-control form-control-lg", {"is-invalid":errors.description})} placeholder="Project Description"></textarea>
                            {errors.description && (
                                <div className="invalid-feedback">
                                   {errors.description}
                                </div>
...
UpdateProject.propTypes = {
    createroject: PropTypes.func.isRequired,
